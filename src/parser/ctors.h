...
extern Node* make_numeric_value(Arena* arena, Node* type, u64 num);
extern Node* make_pointer_value(Arena* arena, Node* type, Node* value);
extern Node* make_basic_type(Arena* arena, TypeKind kind);
extern Node* make_numeric_type(Arena* arena, TypeKind kind, i32 width);
...
extern Node* make_declaration(
  Context cx, Node* type, StrView view, Node* value
);
